...
const stackByVariant = {
  home: {
    ...
    items: [
      ...
      { name: "Meta", slug: "meta", note: "Mídia e ecossistema Meta", partner: true },
      { name: "Hostinger", slug: "hostinger", note: "VPS, hospedagem, domínio e e-mail", partner: true },
      { name: "TikTok", slug: "tiktok", note: "Mídia e descoberta", partner: true },
      { name: "Mercado Livre", slug: "mercadolibre", note: "Ecossistema de marketplace", partner: true },
